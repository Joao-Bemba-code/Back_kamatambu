...
(async () => {
  ...
  try {
    await conn.execute("ALTER TABLE Users MODIFY COLUMN tipo ENUM('admin','pedagogico','tesouraria') DEFAULT 'pedagogico'");
    console.log('Default da coluna tipo alterado para pedagogico');
  } catch (e) {
